  ...
  function content(code) {
    ...
    return make({
      ...
      home: {
        ...
        paths: [
          { label: pick("I already have a case", "মোৰ ইতিমধ্যে এটা মামলা আছে", "मेरा पहले से एक मामला है"), description: pick("Search by case number, party name, advocate, FIR and more.", "মামলা নম্বৰ, পক্ষৰ নাম, অধিবক্তা, FIR আদি ব্যৱহাৰ কৰি বিচাৰক।", "मामला नंबर, पक्षकार, वकील, FIR आदि से खोजें।") },
          { label: pick("I need legal help", "মোক আইনী সহায় লাগে", "मुझे कानूनी मदद चाहिए"), description: pick("Describe your problem and get guidance on courts, lawyers and your rights.", "আপোনাৰ সমস্যা বৰ্ণনা কৰি আদালত, অধিবক্তা আৰু অধিকাৰৰ বিষয়ে পথনিৰ্দেশনা লওক।", "अपनी समस्या बताएँ और अदालत, वकील तथा अधिकारों पर मार्गदर्शन पाएँ।") },
        ],
        searchLabel: pick("Find your case", "আপোনাৰ মামলা বিচাৰক", "अपना मामला खोजें"),
        searchPlaceholder: pick("CNR, case number, party name, advocate name, FIR number...", "CNR, মামলা নম্বৰ, পক্ষৰ নাম, অধিবক্তাৰ নাম, FIR নম্বৰ...", "CNR, मामला नंबर, पक्षकार, वकील का नाम, FIR नंबर..."),
        unknownCase: pick("I don't know my case number", "মই মোৰ মামলা নম্বৰ নাজানো", "मुझे अपना मामला नंबर नहीं पता"),
        commonHeading: pick("Things people commonly need", "মানুহে সাধাৰণতে বিচৰা সহায়", "लोगों को आम तौर पर क्या चाहिए"),
        common: [
          { label: pick("Understand a court paper", "আদালতৰ কাগজ বুজক", "अदालत का कागज़ समझें"), description: pick("Upload a notice or order and we'll explain it.", "জাননী বা আদেশ আপলোড কৰক আৰু আমি বুজাই দিম।", "नोटिस या आदेश अपलोड करें और हम समझाएँगे।") },
          { label: pick("Find the right court or legal help", "সঠিক আদালত বা আইনী সহায় বিচাৰক", "सही अदालत या कानूनी मदद खोजें"), description: pick("Know where to go and who can help.", "ক'লৈ যাব আৰু কোনে সহ সহায় কৰিব পাৰে জানক।", "जानें कहाँ जाना है और कौन मदद कर सकता है।") },
          { label: pick("Know my rights", "মোৰ অধিকাৰ জানক", "अपने अधिकार जानें"), description: pick("Learn about your rights in simple language.", "সহজ ভাষাত আপোনাৰ অধিকাৰ জানক।", "सरल भाषा में अपने अधिकार जानें।") },
          { label: pick("Can I get free legal aid?", "মই বিনামূলীয়া আইনী সহায় পাব পাৰোঁনে?", "क्या मुझे मुफ्त कानूनी सहायता मिल सकती है?"), description: pick("Check whether you may be eligible for free legal help.", "বিনামূলীয়া আইনী সহায়ৰ যোগ্যতা চাওক।", "मुफ्त कानूनी सहायता की पात्रता जाँचें।") },
        ],
        actions: {
          find: x.nav.finder,
          create: pick(
